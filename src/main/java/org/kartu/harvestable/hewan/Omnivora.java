...
public class Omnivora extends Hewan {
    public Omnivora(String nama, String kategori, String imageURL, Integer valuePanen) {
        super(nama, kategori, imageURL, valuePanen);
    }

    public void makan(Kartu kartu) throws Exception {
        if (kartu.getKategori().equals("Produk Hewan") || kartu.getKategori().equals("Produk Tanaman")) {
